...
<div class="header">
        <div class="user-info">
            <span>Welcome, <strong id="username"> <%= username2 %>!</strong></span>
            <p><a href="../LoginOfficer/LGO.html" onclick="">Logout</a></p>
        </div>
    </div>
...
<%
 ...
 String Par_Status = "";
    ...
    try {
        ...
        String query = "SELECT Booking_ID, User_Name, Rec_Name, Rec_Address, Par_Service_COST, Par_Status FROM tbl_BookingData";
